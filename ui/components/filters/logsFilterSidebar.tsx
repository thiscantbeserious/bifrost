...
function ProvidersFilter({ filters, onFiltersChange, defaultOpen }: FilterComponentProps) {
	...
	return (
		<FilterSection title="Providers" defaultOpen={defaultOpen || hasActive} loading={isLoading} onOpenChange={setOpened}>
...
function TypeFilter({ filters, onFiltersChange, defaultOpen }: FilterComponentProps) {
	...
	return (
		<FilterSection title="Type" defaultOpen={defaultOpen || hasActive}>
...
function ModelsFilter({ filters, onFiltersChange, defaultOpen }: FilterComponentProps) {
	...
	return (
		<FilterSection title="Models" defaultOpen={defaultOpen || hasActive} loading={isLoading} onOpenChange={setOpened}>
			<SearchableCheckboxList
				inputRef={searchInputRef}
...
function AliasesFilter({ filters, onFiltersChange, defaultOpen }: FilterComponentProps) {
	...
	return (
		<FilterSection title="Aliases" defaultOpen={defaultOpen || hasActive} loading={isLoading} onOpenChange={setOpened}>
			<SearchableCheckboxList
				inputRef={searchInputRef}
...
function SelectedKeysFilter({ filters, onFiltersChange, defaultOpen }: FilterComponentProps) {
	...
	return (
		<FilterSection title="Selected Keys" defaultOpen={defaultOpen || hasActive} loading={isLoading} onOpenChange={setOpened}>
			<SearchableCheckboxList
				inputRef={searchInputRef}
...
function RoutingEnginesFilter({ filters, onFiltersChange, defaultOpen }: FilterComponentProps) {
	...
	return (
		<FilterSection title="Routing Engines" defaultOpen={defaultOpen || hasActive} loading={isLoading} onOpenChange={setOpened}>
			<SearchableCheckboxList
				inputRef={searchInputRef}
...
function RoutingRulesFilter({ filters, onFiltersChange, defaultOpen }: FilterComponentProps) {
	...
	return (
		<FilterSection title="Routing Rules" defaultOpen={defaultOpen || hasActive} loading={isLoading} onOpenChange={setOpened}>
			<SearchableCheckboxList
				inputRef={searchInputRef}
...
function SessionFilter({ filters, onFiltersChange, defaultOpen }: FilterComponentProps) {
	...
	return (
		<FilterSection title="Session" defaultOpen={defaultOpen || hasActive}>
...
function CostFilter({ filters, onFiltersChange, defaultOpen }: FilterComponentProps) {
	...
	return (
		<FilterSection title="Cost" defaultOpen={defaultOpen || hasActive}>
			<CheckboxFilterItem
...
function MetadataFilters({ filters, onFiltersChange, defaultOpen }: FilterComponentProps) {
	...
	if (!isUninitialized && !isLoading && entries.length === 0 && !hasActive) return null;

	return (
		<>
			{entries.map(([metadataKey, values]) => {
				const keyActive = !!filters.metadata_filters?.[metadataKey];
				return (
					<FilterSection
						key={metadataKey}
						title={`Metadata: ${metadataKey}`}
						defaultOpen={defaultOpen || keyActive}
						loading={isLoading}
